...
extern void fastmem_init(unsigned long thresh_size, unsigned exp_max);
...
extern void fastmem_shrink(unsigned& old_size, unsigned& new_size);
extern void fastmem_used_size(unsigned& used_size);
extern void fastmem_clean(unsigned long& cleaned_size);
#endif
